...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("RunTestCollector: slowforward", new RunTestCollector(0.1));
        SmartDashboard.putData("RunTestCollector: slowreverse", new RunTestCollector(-.1));
