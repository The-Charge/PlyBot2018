...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TextStationOne", new TextStationOne());
        SmartDashboard.putData("TextStationTwo", new TextStationTwo());
        SmartDashboard.putData("TextStationThree", new TextStationThree());
        SmartDashboard.putData("SwitchStationThree", new SwitchStationThree());
        SmartDashboard.putData("SwitchStationTwo", new SwitchStationTwo());
        SmartDashboard.putData("SwitchStationOne", new SwitchStationOne());
