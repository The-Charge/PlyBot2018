...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("TurnNDegreesRelativeTEST: Turn 270 Relative", new TurnNDegreesRelativeTEST(270));
        SmartDashboard.putData("TurnNDegreesRelativeTEST: Turn 0 Relative", new TurnNDegreesRelativeTEST(0));
