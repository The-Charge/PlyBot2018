...
public class OI {
    ...
    public OI() {
        ...
        overrideElevatorDownBtn = new JoystickButton(rightJoystick, 2);
        overrideElevatorDownBtn.whileHeld(new OverrideElevator(false));
        overrideElevatorUpBtn = new JoystickButton(rightJoystick, 1);
        ...
        SmartDashboard.putData("OverrideElevator: OverrideElevator: Up", new OverrideElevator(true));
        SmartDashboard.putData("OverrideElevator: OverrideElevator: Down", new OverrideElevator(false));
