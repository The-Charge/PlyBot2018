...
public class OI {
    ...
    public OI() {
        ...
        elevateTo4PosBtn = new JoystickButton(rightJoystick, 12);
        elevateTo4PosBtn.whenPressed(new ElevateToXPos(4));
        elevateTo3PosBtn = new JoystickButton(rightJoystick, 11);
        elevateTo3PosBtn.whenPressed(new ElevateToXPos(3));
        elevateTo2PosBtn = new JoystickButton(rightJoystick, 10);
        elevateTo2PosBtn.whenPressed(new ElevateToXPos(2));
        elevateTo1PosBtn = new JoystickButton(rightJoystick, 9);
        elevateTo1PosBtn.whenPressed(new ElevateToXPos(1));
        overrideElevatorDownBtn = new JoystickButton(rightJoystick, 4);
        overrideElevatorDownBtn.whileHeld(new OverrideElevator(false));
        overrideElevatorUpBtn = new JoystickButton(rightJoystick, 3);
        ...
        runCollectorReverseBtn = new JoystickButton(rightJoystick, 32);
        runCollectorReverseBtn.whileHeld(new RunCollectorReverse());
        runCollectorForwardBtn = new JoystickButton(rightJoystick, 31);
