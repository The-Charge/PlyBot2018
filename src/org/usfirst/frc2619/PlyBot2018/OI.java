...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("MoveShoulderPositionToX", new MoveShoulderPositionToX());
        SmartDashboard.putData("MoveShoulderLow", new MoveShoulderLow());
        SmartDashboard.putData("MoveShoulderHigh", new MoveShoulderHigh());
        SmartDashboard.putData("MoveShoulderMiddle", new MoveShoulderMiddle());
