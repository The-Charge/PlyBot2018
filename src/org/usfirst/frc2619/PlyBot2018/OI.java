...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ElevateToXFeet: ElevateToXFeet: 1foot", new ElevateToXFeet(1));
        SmartDashboard.putData("ElevateToXFeet: ElevateToXFeet: 2feet", new ElevateToXFeet(2));
        SmartDashboard.putData("ElevateToXFeet: ElevateToXFeet: 5feet", new ElevateToXFeet(5));
        SmartDashboard.putData("ElevateToXFeet: ElevateToXFeet: 0feet", new ElevateToXFeet(0));
