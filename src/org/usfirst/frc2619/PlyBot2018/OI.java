...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Blue", new Blue());
        SmartDashboard.putData("Red", new Red());
        SmartDashboard.putData("Switch", new Switch());
        SmartDashboard.putData("Scale", new Scale());
        SmartDashboard.putData("SwitchAndScale", new SwitchAndScale());
