...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ElevateToX: high", new ElevateToX(50000));
        SmartDashboard.putData("ElevateToX: low", new ElevateToX(0));
        SmartDashboard.putData("ShoulderToX: low", new ShoulderToX(.3));
        SmartDashboard.putData("ShoulderToX: middle", new ShoulderToX(.5));
        SmartDashboard.putData("ShoulderToX: high", new ShoulderToX(.9));
        SmartDashboard.putData("ShoulderToX: midHigh", new ShoulderToX(.7));
