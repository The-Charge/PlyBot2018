...
public class OI {
    ...
    public OI() {
        ...
        openClawBtn.whenPressed(new MoveClaw(true, false));
        closeClawBtn = new JoystickButton(rightJoystick, 8);
        closeClawBtn.whenPressed(new MoveClaw(false, true));
        ...
        shiftLowBtn.whenPressed(new Shift(false, true));
        shiftHighBtn = new JoystickButton(rightJoystick, 4);
        shiftHighBtn.whenPressed(new Shift(true, false));
        ...
        SmartDashboard.putData("MoveClaw: Open", new MoveClaw(true, false));
        SmartDashboard.putData("Shift: high", new Shift(true, false));
