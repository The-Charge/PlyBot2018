...
public class OI {
    ...
    public JoystickButton shoulderHBtn;
    public JoystickButton shoulderMHBtn;
    public JoystickButton shoulderMLBtn;
    public JoystickButton shoulderLBtn;
    ...
    public OI() {
        ...
        shoulderLBtn = new JoystickButton(rightJoystick, 14);
        shoulderLBtn.whenPressed(new ShoulderLow());
        shoulderMLBtn = new JoystickButton(rightJoystick, 13);
        shoulderMLBtn.whenPressed(new ShoulderMidLow());
        shoulderMHBtn = new JoystickButton(rightJoystick, 12);
        shoulderMHBtn.whenPressed(new ShoulderMidHigh());
        shoulderHBtn = new JoystickButton(rightJoystick, 11);
        shoulderHBtn.whenPressed(new ShoulderHigh());
        ...
        SmartDashboard.putData("ShoulderLow", new ShoulderLow());
        SmartDashboard.putData("ShoulderHigh", new ShoulderHigh());
        SmartDashboard.putData("ShoulderMidHigh", new ShoulderMidHigh());
        SmartDashboard.putData("ShoulderMidLow", new ShoulderMidLow());
