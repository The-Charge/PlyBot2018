...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("Drive 1 Second, 0.5 Output", new DriveXSeconds(1, 0.5));
        SmartDashboard.putData("Drive 1 Second, 1.0 Output", new DriveXSeconds(1, 1.0));
        SmartDashboard.putData("Drive 3 Seconds, 0.5 Output", new DriveXSeconds(3, 0.5));
