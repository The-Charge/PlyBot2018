...
public class OI {
    ...
    public OI() {
        ...
        SmartDashboard.putData("ConditionalTurn", new ConditionalTurn());
        SmartDashboard.putData("TurnLeftCG", new TurnLeftCG());
        SmartDashboard.putData("TurnRightCG", new TurnRightCG());
