...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addObject("Blue",  new Blue());
        chooser.addObject("Red",  new Red());
        chooser.addObject("Switch",  new Switch());
        chooser.addObject("Scale",  new Scale());
        chooser.addObject("Switch and Scale",  new SwitchAndScale());
