...
public class Elevator extends PIDSubsystem {
    ...
    private final Solenoid elevatorBrakes = RobotMap.elevatorElevatorBrakes;
    ...
    public void setSetPointFeet(double setPoint) {
    	setSetpoint(setPoint * TICKS_PER_FOOT);
    }
    
    public void brakeOn() {
    	Robot.elevator.elevatorBrakes.set(true);
    }
    
    public void brakeOff() {
    	Robot.elevator.elevatorBrakes.set(false);
    }
