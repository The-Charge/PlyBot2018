 ...
 *
 */
public class StationTwoRightScaleAuton extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public StationTwoRightScaleAuton() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new DriveXFeetMotionMagic(11));
    	addSequential(new TurnNDegreesAbsolutePID(0));
    	addSequential(new DriveXFeetMotionMagic(20.5));
    	addSequential(new TurnNDegreesAbsolutePID(-90));
