 ...
 *
 */
public class RunShoulder extends PIDCommand {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
        ...
        super("RunShoulder", 1.0, 0.0, 0.0, 0.02);
    ...
    protected double returnPIDInput() {
        ...
        return RobotMap.shoulderPotentiometer.pidGet();
    ...
    protected void usePIDOutput(double output) {
        ...
        RobotMap.shoulderShoulderMotor.pidWrite(output);
