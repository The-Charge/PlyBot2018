...
public class ToggleLockStraightGyro extends Command {
	...
	private final double setPoint = RobotMap.driveTrainAHRS.getAngle();
    ...
    protected void execute() {
    	...
    	leftSpeed = leftFrontMotor.getMotorOutputPercent();
    	rightSpeed = rightFrontMotor.getMotorOutputPercent();
