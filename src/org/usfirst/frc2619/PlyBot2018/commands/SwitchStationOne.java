 ...
 *
 */
public class SwitchStationOne extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public SwitchStationOne() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	...
    	if (leftRight.charAt(0) == 'L') {
			addSequential(new StationOneLeftSwitchAuton());
		}
		else if (leftRight.charAt(0) == 'R') {
			addSequential(new StationOneRightSwitchAuton());
		}
