 ...
 *
 */
public class ScaleStationThree extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public ScaleStationThree() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	if (leftRight.charAt(1) == 'L') {
			addSequential(new StationThreeLeftScaleAuton());
		}
		else if (leftRight.charAt(1) == 'R') {
			addSequential(new StationThreeRightScaleAuton());
		}
