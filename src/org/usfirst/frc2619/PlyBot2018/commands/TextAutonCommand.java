...
public class TextAutonCommand extends CommandGroup {
	  private int locFT = 0, locDG = 0, locFTDC = 0;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	while(computedAuton.length() > 0) {
	    	...
	    	locFTDC = computedAuton.indexOf("ftdc");
	    	...
	    	else if (locDG > locFTDC && locFT > locFTDC) {
	    		addSequential(new DriveXFeetMotionMagic(Double.parseDouble(computedAuton.substring(0, locFTDC)) - 1.8));
	    		addSequential(new DriveToCurrent(1.8));
	    		System.out.println("DrivingXFeet & Current");
	    		if(computedAuton.length() > 3)
	    			computedAuton = computedAuton.substring(locFTDC+5);
	    		else
	    			computedAuton = "";
	    	}
    	}
