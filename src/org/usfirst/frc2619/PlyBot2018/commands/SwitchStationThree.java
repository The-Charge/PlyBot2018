 ...
 *
 */
public class SwitchStationThree extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public SwitchStationThree() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	if (leftRight.charAt(0) == 'L') {
			addSequential(new StationThreeLeftSwitchAuton());
		}
		else if (leftRight.charAt(0) == 'R') {
			addSequential(new StationThreeRightSwitchAuton());
		}
