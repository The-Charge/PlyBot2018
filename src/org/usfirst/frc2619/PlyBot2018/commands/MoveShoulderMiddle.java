 ...
 *
 */
public class MoveShoulderMiddle extends Command {
    ...
    protected void initialize() {
    	this.setTimeout(1.5);
    	initial = pot.get();
    	if (Math.abs(Math.abs(initial)-Math.abs(MIDDLE)) < ERROR)
    		end();
    ...
    protected boolean isFinished() {
    	current = pot.get();
        return (Math.abs(Math.abs(current)-Math.abs(MIDDLE)) < ERROR || this.isTimedOut());
    }
