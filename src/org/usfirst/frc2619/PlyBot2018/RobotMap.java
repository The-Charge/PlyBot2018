...
public class RobotMap {
    ...
    public static AnalogPotentiometer shoulderPIDPot;
    public static WPI_TalonSRX shoulderPIDMotor;
    ...
    public static void init() {
        ...
        shoulderPIDPot = new AnalogPotentiometer(2, 1.0, 0.0);
        LiveWindow.addSensor("ShoulderPID", "Pot", shoulderPIDPot);
        
        shoulderPIDMotor = new WPI_TalonSRX(5);
