...
public class RobotMap {
    ...
    public static WPI_TalonSRX shoulderShoulderMotor;
    public static AnalogPotentiometer shoulderPotentiometer;
    ...
    public static void init() {
        ...
        shoulderShoulderMotor = new WPI_TalonSRX(5);
        
        
        shoulderPotentiometer = new AnalogPotentiometer(2, 1.0, 0.0);
