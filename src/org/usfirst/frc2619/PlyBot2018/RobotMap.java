...
public class RobotMap {
    ...
    public static Solenoid clawLeftPiston;
    public static Solenoid clawRightPiston;
    ...
    public static void init() {
        ...
        clawLeftPiston = new Solenoid(0, 1);
        LiveWindow.addActuator("Claw", "LeftPiston", clawLeftPiston);
        
        clawRightPiston = new Solenoid(0, 2);
        LiveWindow.addActuator("Claw", "RightPiston", clawRightPiston);
