...
public class RobotMap {
    ...
    public static AnalogPotentiometer shoulderPot;
    public static WPI_TalonSRX shoulderTalon;
    ...
    public static void init() {
        ...
        shoulderPot = new AnalogPotentiometer(1, 1.0, 0.0);
        LiveWindow.addSensor("Shoulder", "Pot", shoulderPot);
        
        shoulderTalon = new WPI_TalonSRX(6);
