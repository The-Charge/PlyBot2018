...
public class RobotMap {
    ...
    public static Encoder testElevatorQuadratureEncoder1;
    public static GearTooth testElevatorCounter;
    ...
    public static void init() {
        ...
        testElevatorQuadratureEncoder1 = new Encoder(2, 3, false, EncodingType.k2X);
        LiveWindow.addSensor("TestElevator", "Quadrature Encoder 1", testElevatorQuadratureEncoder1);
        testElevatorQuadratureEncoder1.setDistancePerPulse(1.0);
        testElevatorQuadratureEncoder1.setPIDSourceType(PIDSourceType.kDisplacement);
        testElevatorCounter = new GearTooth(4, false);
        LiveWindow.addSensor("TestElevator", "Counter", testElevatorCounter);
